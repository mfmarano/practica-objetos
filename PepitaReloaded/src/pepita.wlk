object pepita {
	...
	var property entrenadorActual = roque
	...
	method entrenate() {
		self.entrenadorActual().realizarRutina(self)
	}
...
object pepon {
	...
	method volar(unosKilometros) {
		energia = energia - 2 * unosKilometros
	}
	
	method comer(unosGramosDeAlpiste) {
		energia = energia + 3 * unosGramosDeAlpiste - 20
	}
